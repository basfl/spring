...
//	        User ur = new User(username, password, authList);
	        myUserDetails.setUser(us);
	        myUserDetails.setPass(user.getPass());
	        myUserDetails.setAccountNotExpired(true);
	        myUserDetails.setAccountNotLocked(true);
	        myUserDetails.setEnable(true);
	        List<GrantedAuthority> authList=new ArrayList<>();
	        authList.add(new SimpleGrantedAuthority("ROLE_USER"));
	        authList.add(new SimpleGrantedAuthority("USER"));
	        myUserDetails.setAuthorities(authList);
